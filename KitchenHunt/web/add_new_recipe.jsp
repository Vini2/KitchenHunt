    ...
    <body>
        ...
        <div style="width:70%; margin:0 auto;">
            <form class="form-horizontal" role="form" onsubmit="postRecipe(this); return false;" method="POST" id="testform">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="email" disabled>Recipe Name:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="recipe_name" name="recipe_name" placeholder="" value="" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="email" disabled>Skill Level:</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="email" disabled>Serving Quantity:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="recipe_qty" name="recipe_qty" placeholder="" value="" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="email" disabled>Preparation Time:</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group"> 
                    <div class="col-sm-offset-2 col-sm-10" align="right" id="action_button">
                        <button type="submit" class="btn btn-success" id="btn_update">Save Recipe</button>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-3 col-md-3">
                            <label class="control-label col-sm-2" for="email" disabled>Ingredient1:</label>
                        </div>
                        <div class="col-xs-4 col-md-4">
                            <input type="text" class="form-control" id="recipe_ing1" name="recipe_ing1" placeholder="" value="">
                        </div>
                        <div class="col-xs-3 col-md-3">
                            <input type="text" class="form-control" id="recipe_ing1_qty" name="recipe_ing1" placeholder="" value="">
                    ...
                    <div class="col-xs-6 col-md-6">
                        <label class="control-label col-sm-2" for="email" disabled>Ingredient2:</label>
                    </div>
                </div>
            </form>
        </div>
