...
public class SignInTest {
    ...
    public void successfulLoginTest() {
        ...
        driver.get("http://www.kitchenhuntr.com/index.jsp");
        ...
        //Enter email
        driver.findElement(By.xpath("//*[@id='signin_form']/div[1]/input")).sendKeys("vini_93@live.com");
        ...
        //Check
        Assert.assertTrue(name.equals("Vijini Gimhani"));
